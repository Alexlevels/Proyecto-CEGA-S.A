...
namespace CEGA.Controllers
{
    public class MarketingController : Controller
    {
        ...
        public IActionResult Marketing()
        {
            ...
            ViewBag.Distribuciones = _context.DistribucionesMarketing.ToList();
        ...
        public IActionResult CrearProgramacionDistribucion(ProgramacionDistribucion model)
        {
            ...
            {
                ModelState.AddModelError("Nombre", "Este programa de distribución ya existe");
                return View("Marketing", model);
            }
            ...
            TempData["Mensaje"] = "Programación de distribución creada exitosamente";
            return RedirectToAction("Marketing");
        }
        [HttpPost]
